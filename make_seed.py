...
const CATEGORY_IMAGES: Record<string, string[]> = {
  ...
  'Bracelet': [
    'https://images.unsplash.com/photo-1611591475819-21b8c66e92ee?q=80&w=800&auto=format&fit=crop',
    'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=800&auto=format&fit=crop'
  ],
  'Kit': [
    'https://images.unsplash.com/photo-1609137144822-2617f6fa6e7b?q=80&w=800&auto=format&fit=crop',
  ...
  'General': [
    ...
    'https://images.unsplash.com/photo-1608755728617-aefab37d45f6?q=80&w=800&auto=format&fit=crop',
...
export async function seed() {
  ...
  const categoryDefs = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1611591475819-21b8c66e92ee?q=80&w=800&auto=format&fit=crop',
      displayOrder: 4
    },
    {
      name: 'Spiritual Kits',
      ...
      image: 'https://images.unsplash.com/photo-1609137144822-2617f6fa6e7b?q=80&w=800&auto=format&fit=crop',
      displayOrder: 5
    },
    {
...
target = r"C:\Users\Akash Neelgund\.gemini\antigravity\scratch\vedic-ecommerce\backend\src\seeds\seed.ts"
with open(target, "w", encoding="utf-8") as f:
    f.write(content)

print("Generated seed.ts successfully!")